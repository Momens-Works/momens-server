...
/**
 * {@link ProjectOwner}의 복합 식별자.
 *
 * <p>레거시 {@code project_owners}는 {@code (project_id, owner_user_id)} 복합 PK라 단일 UUID PK용 {@link
...
public class ProjectOwnerId implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof ProjectOwnerId that)) {
      return false;
    }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(projectId, ownerUserId);
  }
}
