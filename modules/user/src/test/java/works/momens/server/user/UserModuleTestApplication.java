 ...
 *
 * <p>{@code @ComponentScan}을 둡니다: {@code @DataJpaTest}는 auto-config 패키지로 엔티티/repository를 찾지만,
 * {@code @WebMvcTest}는 컨트롤러를 component scan으로 발견하기 때문입니다. 각 슬라이스의 TypeExcludeFilter가 관련 없는 빈을 걸러내므로
 * 두 슬라이스 모두 안전합니다.
 */
