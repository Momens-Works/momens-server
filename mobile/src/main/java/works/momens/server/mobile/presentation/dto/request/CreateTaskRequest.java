 ...
 *
 * <p>title, roles, priority 모두 필수입니다(2026-07-06 기획 확정). roles는 하나 이상 선택하고 중복은 허용하지 않으며, 각 값은
 * pm/design/backend/frontend/android/qa 중 하나입니다(생성 화면 역할 칩은 중복 선택 불가). priority는 low/medium/high 중
 * 하나입니다.
 */
...
public record CreateTaskRequest(
    ...
    @Schema(
            description = "역할. 하나 이상 선택하고 중복은 허용하지 않습니다. pm/design/backend/frontend/android/qa",
            example = "[\"android\"]")
        @NotEmpty
        @UniqueElements
