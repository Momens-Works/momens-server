...
- `docs/rules/` — standing project-wide rules (what to follow), organized by area
...
- `docs/onboarding.md`, `docs/local-development.md` — guides
- `docs/pending-decisions.md` — open decisions; do NOT infer these, decide with the team
