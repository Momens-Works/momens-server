...
- [상세설계 > 첫 웹 read 슬라이스 계약 (워크스페이스 조회)](design/legacy-product-api-migration-workspace-read-design.md)
- [상세설계 > 웹 snapshot 계약 (H023)](design/legacy-product-api-migration-snapshot-design.md)
